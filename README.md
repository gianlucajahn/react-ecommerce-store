...
- Working with a CDN (Cloud Delivery Network) to further improve an application's performance by accelerating bundle delivery
- organizing a bigger interconnective homepage and connect it with React Router Dom
